...
// If the period between pulses is too high, or even if the pulses stopped, get stuck
// last value instead of a 0. - limit for the maximum period
// If the period is above this value, the RPM show as 0.
// The higher the longer lag/delay will have to sense that pulses stopped, but it will allow readings
// at very low RPM.
...
// Variables:
/////////////
volatile unsigned long LastTimeWeMeasured;  // Stores the last time we measured
